...
import { View, Text, TouchableOpacity, StyleSheet, Modal, Image, Button, Platform } from 'react-native';
...
const ManagerScreen = () => {
  ...
  const handleSwitchBar = () => {
    navigation.navigate('ManagerBarSelection');
  };
